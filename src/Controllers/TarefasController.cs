...
namespace catelanDapper.Controllers

{
    [Route("api/[controller]")]
    [ApiController]
    public class TarefasController : ControllerBase
    {private readonly Repository.ITarefaRepository _tarefaRepo;
       public TarefasController(Repository.ITarefaRepository tarefaRepo)
       {
       ...
       [HttpPost]
       [Route("criartarefa")]
       public async Task<IActionResult> SaveAsync(Data.Tarefa novaTarefa)
       {
       ...
       public async Task<IActionResult> UpdateTodoStatusAsync(Data.Tarefa atualizaTarefa)
       {
